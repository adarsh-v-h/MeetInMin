...
function Register() {
  ...
  // Simple eye icon SVG based on state
  const EyeIcon = ({ show }) => (
          ...
          <div style={{ padding: '4rem 3rem', display: 'flex', flexDirection: 'column', justifyContent: 'center', textAlign: 'center' }}>
            ...
            <form style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
              <div style={inputContainerStyle}>
                <input type="text" name="username" autoComplete="username" placeholder="Username" style={inputStyle} />
              </div>
              
              <div style={inputContainerStyle}>
                <input type="email" name="email" autoComplete="email" placeholder="Email Address" style={inputStyle} />
              </div>
              
              <div style={inputContainerStyle}>
                <input type={showPassword ? "text" : "password"} name="password" autoComplete="new-password" placeholder="Password" style={inputStyle} />
              ...
              <div style={inputContainerStyle}>
                <input type={showConfirmPassword ? "text" : "password"} name="confirm_password" autoComplete="new-password" placeholder="Confirm Password" style={inputStyle} />
                <button type="button" onClick={() => setShowConfirmPassword(!showConfirmPassword)} style={iconButtonStyle}>
                  <EyeIcon show={showConfirmPassword} />
                </button>
              </div>
              
              <button type="button" className="btn-primary" style={{ marginTop: '0.5rem', width: '100%' }}>Sign Up</button>
            </form>
